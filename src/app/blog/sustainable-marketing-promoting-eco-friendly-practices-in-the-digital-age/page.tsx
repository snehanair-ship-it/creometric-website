...
export const metadata = {
  title: "Sustainable Marketing: Promoting Eco-Friendly Practices in the Digital Age | Creometric",
  description:
    "Discover how sustainable marketing strategies can help your brand stand out while promoting eco-friendly practices. Learn actionable tips from Creometric, a digital marketing agency in Goa, India.",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-[#8A8A8A] space-y-6">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Consumer demand is rising.</strong> Studies consistently show that a significant majority of consumers prefer to buy from brands that demonstrate environmental responsibility. Younger demographics, including millennials and Gen Z, are particularly vocal about supporting sustainable businesses.
              </li>
              <li>
                <strong>Brand differentiation.</strong> In crowded markets, a genuine commitment to sustainability sets your brand apart. It gives customers a reason to choose you over competitors who have not made the same commitment.
              </li>
              <li>
                <strong>Long-term cost savings.</strong> Digital marketing is inherently more resource-efficient than traditional marketing channels like print, direct mail, or billboard advertising. Leaning into digital-first strategies reduces waste while reaching larger audiences.
              </li>
              <li>
                <strong>Regulatory preparedness.</strong> Governments around the world are introducing stricter environmental regulations. Brands that proactively adopt sustainable practices are better positioned to comply with future requirements.
              </li>
              <li>
                <strong>Investor and partner appeal.</strong> ESG (Environmental, Social, and Governance) criteria are increasingly important to investors. A strong sustainability record can open doors to new funding and partnerships.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Back up every claim with data or third-party certifications.</li>
              <li>Avoid vague language like &quot;eco-friendly&quot; or &quot;green&quot; without specific context.</li>
              <li>Be honest about limitations — no brand is perfectly sustainable.</li>
