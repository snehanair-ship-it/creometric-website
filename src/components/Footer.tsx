...
const services = [
  ...
  { href: "/service/", label: "Social Media Management" },
    ...
    <footer className="bg-gray-900 text-gray-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://www.linkedin.com/company/creometric"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://twitter.com/creometric"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <a
              href="/#contact"
              className="inline-block mt-5 rounded-full bg-orange-500 text-white px-5 py-2.5 text-sm font-medium hover:bg-orange-600 transition-colors"
            >
              Book a Free Call
            </a>
          </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-500">
          <p>&copy; {new Date().getFullYear()} Creometric. Digital Transformation Partner &mdash; Kilowott</p>
